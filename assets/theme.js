...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      cartPopupCartQuantity: '[data-minicart-quantity]',
      cartPopupClose: '[data-minicart-close]',
      cartPopupProductDetails: '[data-mincart-product-details]',
      cartPopupQuantity: '[data-minicart-quantity]',
      cartPopupQuantityLabel: '[data-minicart-quantity-label]',
      cartPopupTitle: '[data-minicart-title]',
      cartPopupWrapper: '[data-minicart-wrapper]',
      loader: '[data-loader]',
    ...
    _addItemToCart: function(form) {
      ...
      fetch('/cart/add.js', {
        ...
        .then(function(json) {
          ...
          document.querySelector('.minicart').classList.add('visible');
          document.querySelector('.bg-drop').classList.add('visible');
